...
const capacity = [
 {label:"Direct today",value:"2 hotshots · 1 sprinter · 1 power unit",body:"Current equipment supporting direct operations. Trailer access may be leased or borrowed depending on the job."},
 {label:"Affiliated capacity",value:"Approximately 40 trucks & trailers",body:"Separate carrier assets available through relationships built over roughly a decade. We coordinate them through the brokerage; we do not call them a Five Nines-owned fleet."},
...
const updates = [
 {date:"September 2026",title:"Publishing the capacity model",body:"We separated direct equipment, affiliated carrier capacity, and the extended partner network across the site. Customers should know who is providing the equipment before a load moves."},
