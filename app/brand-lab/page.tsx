...
import { HybridPlateMark, MarkApplication, NetworkFiveMark, SerialPlateMark } from "@/components/brand-lab/candidate-marks"
...
export default function BrandLabPage() {
  return <main style={labTheme} className="bg-background"><SiteHeader />
    ...
    <section className="border-t border-border bg-grid-technical"><div className="mx-auto max-w-6xl px-4 py-16 sm:px-6"><p className="font-mono text-xs uppercase tracking-wider text-muted-foreground">Portal direction</p><div className="mt-8"><PortalPreview /></div></div></section>
