...
import { AssetTagMark, BracketLockupMark, HybridPlateMark, MarkApplication, ReticleMark, SerialPlateMark, ViewfinderMark } from "@/components/brand-lab/candidate-marks"
...
const directions = [
  { id: "E", name: "Viewfinder Lock", tag: "Recommended lead", note: "Four corner brackets locked on a live green core — a viewfinder that keeps the shipment in frame. Reads instantly at favicon scale and stencils cleanly onto a gate.", Mark: ViewfinderMark },
  { id: "H", name: "Bracket Lockup", tag: "E meets the wordmark", note: "The viewfinder brackets frame the 5N itself, so the load kept in frame becomes the name. Bridges the strongest mark and the utility wordmark into one lockup.", Mark: BracketLockupMark },
  { id: "A", name: "5N Network Plate", tag: "Machine-tag character", note: "The machinery tag and the wordmark become one mark. Enough character for a truck door, stays orderly in a document header.", Mark: HybridPlateMark },
  ...
  { id: "I", name: "Freight Hang Tag", tag: "Nameplate, made physical", note: "A pointed shipping tag with a punch hole and a status lamp — the nameplate family turned into an object you would zip-tie to a load. More ownable than a plain rectangle.", Mark: AssetTagMark },
  { id: "J", name: "Reticle Lock", tag: "Round sibling of E", note: "A targeting reticle with N/E/S/W ticks locked on a live core. Same never-lose-the-load idea as the viewfinder, rendered as a circular badge for avatars and stamps.", Mark: ReticleMark },
]
