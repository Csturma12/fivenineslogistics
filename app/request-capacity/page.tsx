...
export const metadata: Metadata = {
  ...
  description:
    "Tell Five Nines Logistics what needs to move, where it is going and when it needs to arrive. Connect with a freight coordinator for capacity and pricing.",
};
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
            <div>
              ...
              <p className="mt-5 max-w-md text-pretty text-base leading-relaxed text-muted-foreground">
                Give us the lane, the load and the delivery window. Your
                coordinator will review the requirements, confirm available
                options and work through pricing with you. For urgent freight,
              ...
              <div className="mt-8 rounded-xl border border-border bg-card p-5">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Operating as an agent of {site.authority} ({site.mc}) — fully
                  authorized and insured. Need a certificate of insurance, or to
                  be added as a certificate holder? Just ask your coordinator
